...
#            remove_list = ["sara", "shackleton", "chris", "germani"]
            for word in ["sara", "shackleton", "chris", "germani", "sshacklensf", "cgermannsf"]:
                ...
                parsed_text = parsed_text.strip()   #remove extra space in the beginning
                parsed_text = ' '.join(parsed_text.split())   #remove duplicate space 
...
data = tfidf.fit_transform(word_data)
