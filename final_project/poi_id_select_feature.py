...
features_list = ['poi', "fraction_from_poi", "fraction_to_poi", "salary", "bonus", "total_stock_value", 'restricted_stock' ] # You will need to use more features
...
#clf = SVC(kernel = "rbf", C = 1000, gamma = 0.3)
#
