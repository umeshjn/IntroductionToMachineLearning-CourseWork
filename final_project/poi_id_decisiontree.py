...
features_list = ['poi', "fraction_from_poi", "fraction_to_poi", "salary", "bonus", "total_stock_value"] # You will need to use more features
...
train_features, test_features, train_labels, test_labels = cross_validation.train_test_split(features, labels, test_size =0.4, random_state=27)
...
clf = DecisionTreeClassifier(min_samples_split=2, splitter='best')    # Provided to give you a starting point. Try a varity of classifiers.
